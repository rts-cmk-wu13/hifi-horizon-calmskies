            ...
            <div className=" p-10">
                ...
                <div className=" p-10">
                    <h2 className="text-2xl pb-2">
                        Here at HiFi Horizon, our trained product specialists aim to provide the right product for you.
                        We take great care with all of our orders to ensure you are fully happy with the product.
                    </h2>
                    <p className="pb-2">
                    ...
                    <h2 className="font-bold" id="refunds">REFUNDS</h2>
                    <p className="pb-2">
                    ...
                    <h2 className="font-bold" id="delivery">DELIVERY</h2>
                    <p>
                    ...
                    <h2 className="font-bold">RETURNS PROCESS/YOUR STATUTORY RIGHTS</h2>
                    <p className="pb-2">
